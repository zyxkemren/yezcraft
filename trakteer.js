    ...
    (function () {
      ...
      return {
        init: function (a, i, l, c, d = 40, s = "inline", p = !1) {
          ...
          t++,
            (l += "?embedId=" + m),
            (e[m] = { text: a, color: i, url: l, src: c, size: d / 40, pos: s }),
            (r =
            ...
            p ||
              ...
              (n = "https://fonts.googleapis.com/css?family=Quicksand:400,700")),
            (o =
              ...
              var t = function (t) {
                b ||
                  ...
                  t.addEventListener(
                    ...
                    function () {
                      if (!f) {
                        var t = document.querySelector("#trbtn-overlay-container-" + m + " .trbtn-txt");
                      ...
                      var r = document.querySelector("#trbtn-overlay-" + m + " iframe");
                      r &&
                        ((document.getElementById("trbtn-overlay-" + m).style.display = "block"),
                        r.contentWindow.postMessage({ type: "embed.openModal" }, "*"));
                    },
                    !1
                  ));
              };
              p
                ? t(document.getElementById("trbtn-overlay-container-" + m).querySelector(".trbtn"))
                : trbtnOverlay.updateSize(m, t);
            };
          return "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", g) : g(), m;
        },
        updateSize: function (t, n = null) {
          var r,
            ...
            l = setInterval(function () {
              r || (r = document.getElementById("trbtn-overlay-container-" + t)),
                r &&
        ...
        draw: function (t) {
          ...
          if (((i.innerHTML = r.replace("[src]", a.src)), document.head.appendChild(i), n)) {
            var l = document.createElement("link");
            (l.href = n), (l.rel = "stylesheet"), (l.type = "text/css"), document.head.appendChild(l);
          }
